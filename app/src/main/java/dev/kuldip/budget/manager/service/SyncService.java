package dev.kuldip.budget.manager.service;
...
import dev.kuldip.budget.manager.di.component.DaggerServiceComponent;
import dev.kuldip.budget.manager.di.component.ServiceComponent;
...
public class SyncService extends Service {
    ...
    public void onCreate() {
        ...
        ServiceComponent component = DaggerServiceComponent.builder()
                .applicationComponent(((BudgetApp) getApplication()).getComponent())
                .build();
